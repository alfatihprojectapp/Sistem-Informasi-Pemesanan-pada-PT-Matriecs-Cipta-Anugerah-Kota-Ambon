            ...
            <div class="modal-dialog modal-dialog-scrollable modal-xl">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <input type="hidden" wire:model.defer="image_1_old">
                        <input type="hidden" wire:model.defer="image_2_old">
                        <input type="hidden" wire:model.defer="image_3_old">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-floating mb-3">
                                        <input type="text" class="form-control @error('harga') is-invalid @enderror"
                                            placeholder="Harga Rumah" name="harga" id="harga" wire:model.defer="harga">
