                ...
                <div class="row mb-2">
                    <div class="col-md-12">
                        <h5 class="m-0">{!! $icon !!} {{ $title_page }}
                            <span class="badge bg-primary">{{ $jumlah_pelanggan }}</span>
                        </h5>
                    </div>
                </div>
            </div>
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        @if ($pelanggan->count())
                                        ...
                                        @foreach ($pelanggan as $data)
                                            <tr>
                                                ...
                                                <td style="vertical-align: middle;text-align: center;">
                                                    ...
                                                    <button class="badge bg-danger py-2 border-0" title="Hapus"
                                                        wire:click="delete({{ $data->id_pelanggan }})">
                                                        <span wire:loading.remove
                                                            wire:target="delete({{ $data->id_pelanggan }})"><i
                                                                class="bi bi-x-lg"></i></span>
                                                        <span wire:loading
                                                            wire:target="delete({{ $data->id_pelanggan }})"
                            ...
                            <div class="d-flex justify-content-end">{{ $pelanggan->links() }}</div>
                        @else
                            <hr>
